#!/usr/bin/env python
# Started from
# https://github.com/pimoroni/pmw3901-python/blob/master/examples/motion.py
...
spi_cs_gpio = BG_CS_FRONT_BCM if args.spi_slot == 'front' else BG_CS_BACK_BCM
flo = SensorClass(spi_port=0, spi_cs_gpio=spi_cs_gpio)
